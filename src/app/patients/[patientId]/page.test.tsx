...
function setup({ patientOverride = {}, role = "therapist", progressOverride = MOCK_PROGRESS, patientError = null }: { patientOverride?: object; role?: string; progressOverride?: typeof MOCK_PROGRESS; patientError?: Error | null } = {}) {
...
describe("PatientDetailPage — workspace clínico", () => {
  ...
  it("renderiza el nombre completo del paciente", () => {
    setup(); render(<PatientDetailPage />);
  ...
  it("rol patient NO ve acciones rápidas ni resumen clínico", () => {
    setup({ role: "patient" }); render(<PatientDetailPage />);
